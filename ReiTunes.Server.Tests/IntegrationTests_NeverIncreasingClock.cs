...
namespace ReiTunes.Server.Tests {
    ...
    public class IntegrationTests_NeverIncreasingClock {
        ...
        public async Task Integration_BasicItemSync() {
            ...
            var client1 = new Library("machine1", SQLiteHelpers.CreateInMemoryDb(), _serverCaller, clock);
            var client2 = new Library("machine2", SQLiteHelpers.CreateInMemoryDb(), _serverCaller, clock);
